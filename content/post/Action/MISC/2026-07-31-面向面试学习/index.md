---
title: "面向面试学习"
date: 2026-07-31T16:01:09+08:00
description: 老版文章三合一大甩卖!
...
>[!NOTE]
>
>用!结尾的标题/内容表示这一知识通常只在实习和校招中有用,而职招由于都是老油条就不需要看或者接触这些琐碎的知识了.
...
不然的话,面试的时候有的你苦吃的,毕竟面试官都是**有备而来**的,而那么多库和特性,就算是超人也不可能全部记住吧,总会有一些犄角旮旯的知识你不熟悉吧.
### 到底招什么
...
## 大杀器: AI面试(8/14)
在AI如此强大的当下,抛出自己要面试的岗位,AI就可以直接生成强相关的常见面试题,来拷打你的技术水平是否适合这个岗位,不得不说,效果很好!

![GPT测试](PixPin_2026-08-14_13-48-33.webp)


# 面试
## 面试投递环节
### 简历编写
事实上,写简历是最能考验一个人的技术储备的环节,每当你摸不透自己的技术水平时,就去写个简历,立马就能对自己的无能而无地自容.

而写简历自然不可能用word去一个个敲,最好还是找个模板来直接复用就行了.
#### 简历模板
...
## 技术题(废)
技术题才是面试的重中之重,只要技术过关,其他三项不是太拉跨也无所谓,因此我在此处调研了多个领域的技术题,总结出各个领域所需的知识点,如果这些知识点你想都不想就能回答出来的话,那该你拿offer.
...
不过说真的,看几本有体系的计算机网络相关书用的时间比看二手的总结和博客文章要少的多吧,一般看完之后上面的问题基本能了解的很透彻了.
### 操作系统!
- 通用
  - **进程和线程之间有什么区别？**
  - **进程间有哪些通信方式？**
...
#### Android(待补充)
#### 数据库!
由于很多后端岗位都需要涉及跟数据库的交互,因此面试题里总会问到数据库的具体数据结构等这些知识点.
- Redis
  - **使用Redis有哪些好处**
  - **Redis性能问题都有哪些**
  - **Redis的同步机制**
...
- Unity
### 架构,运维与场景题
这部分的知识以前基本是面向中高级工程师的,而在高度内卷的当下即便是实习生也可能会被问到这些问题,或者干脆写在招聘条件里
...
### NLP/ML/CV(待补充)
这三个领域的很多知识都是掺杂在一起的,所以就放到一起了,不过我个人不是很了解这些领域,待日后收集吧.
- **CPU和GPU的区别？**
- **深度学习框架有哪些？各有什么特点？**
- **求解马尔科夫决策过程都有哪些方法？**
...
## 总结
>[!NOTE]
三个月前我写第一版文章的时候还觉得搜集的这些问题都是闻所未闻的,但现在这些问题看起来都非常的简单,就算有部分不太了解的也知道这些问题很容易解决.因此请相信自己的实力,也别高估了面试官的实力😆


# 个人经验
光说不做可要不得,下面是我个人应用上面那些招法的心路历程
## 仓库推荐
### 面经合集

## 网站推荐
### [System Design Questions](https://www.hellointerview.com/)
...
其中1,2,3部分主要由AI从wiki总结生成,毕竟这种没太多乾坤的东西靠我自己来翻译还是太累了.
## 国际企业
该类企业有以下优缺点:
1. 工资较高,福利好,无996
2. 应试要求低,但一般都要求英语好
