...
![alt text](PixPin_2026-05-23_10-48-44.webp)
...
- 这一章书上讲的很烂,我只好重新自己梳理一下

我们需要考虑一个问题,游戏联机与普通的网站开发不同,网站开发可以在前后端内传递json文件,将数据有组织的一一发送出去;
...
因此,我们不能简单的把在玩家的本地数据映射到服务器数据上,需要将游戏数据序列化处理,实现更低的延迟和数据安全,更为实际的解决方法有两种:
