...
渐渐的,我的想法从要不要保研跳转到了要不要考研,但我对自己的专业技能仍然没有信心,所以还是很焦虑.
...
不管怎样,AI推荐我学习fastapi来搭后端,那有啥,就开始学呗,但跟着fastapi破碎的官方教程下来,虽然我啥都没有学到,但自以为可以开始了,于是就点开前端部分的代码,发现实在是无从下手,于是就开始从零学习前端,自然也是问的AI,AI推荐我学习js后再学习nextjs.
