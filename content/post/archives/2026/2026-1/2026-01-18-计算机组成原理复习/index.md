...
## 第一章 概论
### 计算机5个部件的示意图
![示意图](PixPin_2026-01-13_09-42-23.webp)
>由于运算器(ALU)与控制器都集成在cpu上,因此可以写成下图形式

![示意图](PixPin_2026-01-13_09-44-09.webp)
而早期的冯诺伊曼结构是这样的
![示意图](PixPin_2026-01-13_09-47-07.webp)
...
![示意图](PixPin_2026-01-13_13-32-56.webp)
>无论正负均用一个式子表示

![示意图](PixPin_2026-01-13_13-35-46.webp)

### 数的浮点表示
>浮点是指小数点的位置不固定,随时浮动

![示意图](PixPin_2026-01-13_13-57-51.webp)
...
#### 例题
![示意图](PixPin_2026-01-13_14-02-32.webp)
...
- 操作数:操作码操作的对象数据
**指令的基本格式**
![示意图](PixPin_2026-01-13_17-17-33.webp)

### 指令的地址码
地址码中的地址可以为0,1个或多个,根据指令中地址码中的地址数量可以分为以下5种指令

#### 零地址指令
![示意图](PixPin_2026-01-13_17-21-33.webp)
>通常在两种情况下可能采用零地址指令
1. 指令本身不需要任何操作数
2. 指令中所需的操作数是隐含指定的
#### 一地址指令
![示意图](PixPin_2026-01-13_17-21-59.webp)
>在两种情况下可能采用一地址指令
...
2. 指令操作需要两个操作数，指令中指明一个操作数，而另外一个操作数在默认的某个地方
   ...
   - AC <- [AC] OP [A]
#### 二地址指令
![示意图](PixPin_2026-01-13_17-26-04.webp)
- A1 <- [A1] OP [A2]
>根据存放操作数的位置不同，分为3种。
1. 寄存器-寄存器型（R-R型）指令
2. 存储器-存储器型（M-M型）指令
...
**扩展示例**
![示意图](PixPin_2026-01-13_17-41-26.webp)
...
![示意图](PixPin_2026-01-13_17-49-37.webp)
...
![示意图](PixPin_2026-01-13_17-54-10.webp)
#### 立即寻址
...
![示意图](PixPin_2026-01-13_18-10-32.webp)
#### 隐含寻址
>指令中不给出操作数的地址
...
- 形式地址（偏移量）的值可正可负。
- 对于短跳转和程序的再定位很有用。 
![示意图](PixPin_2026-01-13_18-12-10.webp)
...
![示意图](PixPin_2026-01-13_18-13-41.webp)
#### 基址寻址
...
![示意图](PixPin_2026-01-13_18-52-58.webp)
...
![示意图](PixPin_2026-01-13_18-54-43.webp)
##### 混合型编码格式
>提供若干种固定的指令字长,以期达到既能够减少目标代码长度又能降低译码复杂度的目标。
![示意图](PixPin_2026-01-13_18-55-00.webp)
...
![示意图](PixPin_2026-01-14_10-29-31.webp)
...
![示意图](PixPin_2026-01-14_10-30-12.webp)
...
### 构建基本的数据通路
![示意图](PixPin_2026-01-14_10-39-16.webp)
...
![示意图](PixPin_2026-01-14_10-53-11.webp)
#### 构建R类指令
![示意图](PixPin_2026-01-14_10-55-38.webp)
#### 构建访存指令(load和store)
![示意图](PixPin_2026-01-14_10-58-09.webp)
![示意图](PixPin_2026-01-14_10-59-29.webp)
![示意图](PixPin_2026-01-14_11-01-46.webp)
#### beqz指令
![示意图](PixPin_2026-01-14_11-10-09.webp)
![示意图](PixPin_2026-01-14_11-10-38.webp)
### ALU控制器
![示意图](PixPin_2026-01-14_11-18-57.webp)
>ALU完成具体的运算有5个：加、减、或、与、比较

![示意图](PixPin_2026-01-14_11-20-40.webp)
### 多周期实现方案
#### 为什么用多周期
...
* 微指令字太长
![示意图](PixPin_2026-01-14_14-53-30.webp)
...
* 一条微指令只能产生一个微命令
* 无法利用硬件的并行性
![示意图](PixPin_2026-01-14_14-54-21.webp)
...
![示意图](PixPin_2026-01-14_14-55-50.webp)
...
* 只有这样才能有效缩短微指令字长
* 解释字段应具有一定的分类特征
![示意图](PixPin_2026-01-14_14-56-53.webp)
...
* 转移地址字段 BAF
![示意图](PixPin_2026-01-14_15-45-43.webp)
**转移地址的来源有 3 种**
...
![示意图](PixPin_2026-01-14_15-46-10.webp)
**后继微地址的组成**
...
![示意图](PixPin_2026-01-14_17-40-21.webp)

>采用变形补码,将符号位扩展为2位,若运算结果的两个符号位不同,则发生了溢出

![示意图](PixPin_2026-01-14_17-46-46.webp)
### 定点数乘除法运算
#### 原码一位乘法
![示意图](PixPin_2026-01-14_17-53-17.webp)
### 浮点数加减法运算
...
![示意图](PixPin_2026-01-13_21-57-01.webp)
### 存储器分类
#### 按在计算机系统中的作用分类 
1. **主存储器**,又简称为主存或内存。
