...
![alt text](../images/2026-03-25/PixPin_2026-03-27_12-43-31.webp)
#### 语义分析
语义分析器(Semantic Analyzer)对表达式进行**静态**的语义分析,标识各个表达式的类型;动态语义则只能在运行期确定.
![alt text](../images/2026-03-25/PixPin_2026-03-27_12-44-40.webp)
#### 中间代码的生成
...
### 链接概览
![alt text](../images/2026-03-27/PixPin_2026-03-31_13-09-29.webp)
链接有以下几个步骤:
...
### ELF文件的内容
![alt text](../../images/2026-04-08/PixPin_2026-04-09_14-02-28.webp)
...
![alt text](../../images/2026-04-08/PixPin_2026-04-10_15-06-33.webp)
...
## 静态链接(4/15)
![alt text](../../images/2026-04-18/PixPin_2026-04-19_15-13-29.webp)
...
![alt text](../../images/2026-04-18/PixPin_2026-04-19_15-18-14.webp)
显然,这种做法非常浪费空间,会堆积一大堆冗余数据

#### 相似段合并
将相同性质的段合并到一起是一个更为实际的方法,也是主流的链接器空间分配策略:
![alt text](../../images/2026-04-18/PixPin_2026-04-19_15-22-42.webp)
这种链接方式分为两步:
...
### 统计语言模型
![alt text](../../images/2026-04-14/PixPin_2026-04-15_14-04-30.webp)
...
### 神经语言模型
#### NNLM模型
![alt text](../../images/2026-04-14/PixPin_2026-04-15_14-11-19.webp)
...
![alt text](../../images/2026-04-14/PixPin_2026-04-15_14-15-26.webp)
...
![alt text](../../images/2026-04-14/PixPin_2026-04-17_11-43-43.webp)
### Transformer模型分类
...
![alt text](../../images/2026-04-03/PixPin_2026-04-04_11-48-15.webp)
