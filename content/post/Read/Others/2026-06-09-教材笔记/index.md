...
基于以上考量,所以我直接放弃MINIX学习了.



## Linux
```bash
git clone --branch v3.0 --depth 5 https://github.com/torvalds/linux.git
```
由于对版本号的要求,所以我选取了比较有代表性的linux3.0版本(15年前).
...
# 分布式系统
## 评分标准
| 评分项目              | 具体内容                                 | 分值占比 | 详细说明/截止时间      |
| :-------------------- | :--------------------------------------- | :------: | :--------------------- |
| **平时分数**          | **小测 * 2 + 出勤**                      | **15%**  | 5% * 2 + 5% (课堂随机) |
| **编程作业 - Part A** | **Linux脚本编程**                        | **45%**  | 5% (第2周交作业)       |
|                       | **Socket网络编程**                       |          | 10% (第4周交作业)      |
|                       | **分布式数据查询 + 节点成员服务系统**    |          | 30% (第8周交作业)      |
| **编程项目 - Part B** | **机器学习系统**<br>*(加速、压缩等主题)* | **40%**  | 40% (第16周交作业)     |

为什么每个作业和项目都是我计划去学的啊,这也太对胃口了.
